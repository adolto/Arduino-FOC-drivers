...
{
    DRV8311_FLT_MODE fltMode = { .reg = readRegister(DRV8311_FLT_MODE_OFFSET) };
...
{
    return (DRV8311_UnderVoltageProtectionFaultMode)((DRV8311_FLT_MODE)readRegister(DRV8311_FLT_MODE_OFFSET)).UVP_MODE;
};
...
{
    return (DRV8311_OverCurrentProtectionFaultMode)((DRV8311_FLT_MODE)readRegister(DRV8311_FLT_MODE_OFFSET)).OCP_MODE;
};
...
{
    return (DRV8311_SPIFaultMode)((DRV8311_FLT_MODE)readRegister(DRV8311_FLT_MODE_OFFSET)).SPIFLT_MODE;
};
...
{
    return (DRV8311_SystemFaultMode)((DRV8311_FLT_MODE)readRegister(DRV8311_FLT_MODE_OFFSET)).OTPFLT_MODE;
};
...
{
    return (DRV8311_CSAREFUnderVoltageFaultEnable)((DRV8311_SYSF_CTRL)readRegister(DRV8311_SYSF_CTRL_OFFSET)).CSAREFUV_EN;
};

void DRV8311Driver::setCSAREFUnderVoltageFaultEnable(DRV8311_CSAREFUnderVoltageFaultEnable enable)
{
    DRV8311_SYSF_CTRL sysfCtrl = { .reg = readRegister(DRV8311_SYSF_CTRL_OFFSET) };
...
{
    return (DRV8311_OverTemperatureWaringFaultEnable)((DRV8311_SYSF_CTRL)readRegister(DRV8311_SYSF_CTRL_OFFSET)).OTW_EN;
};
...
{
    return (DRV8311_AVDDOverTemperatureFaultEnable)((DRV8311_SYSF_CTRL)readRegister(DRV8311_SYSF_CTRL_OFFSET)).OTAVDD_EN;
};
...
{
    return (DRV8311_OCPLevel)((DRV8311_DRVF_CTRL)readRegister(DRV8311_DRVF_CTRL_OFFSET)).OCP_LVL;
};

void DRV8311Driver::setOCPLevel(DRV8311_OCPLevel level)
{
    DRV8311_DRVF_CTRL drvFltCtrl = { .reg = readRegister(DRV8311_DRVF_CTRL_OFFSET) };
...
{
    return (DRV8311_OCPBlankingTime)((DRV8311_DRVF_CTRL)readRegister(DRV8311_DRVF_CTRL_OFFSET)).OCP_TBLANK;
};
...
{
    return (DRV8311_OCPDeglitchTime)((DRV8311_DRVF_CTRL)readRegister(DRV8311_DRVF_CTRL_OFFSET)).OCP_DEG;
};
...
{
    return (DRV8311_FastRecoveryRetryTime)((DRV8311_FLT_TCTRL)readRegister(DRV8311_FLT_TCTRL_OFFSET)).FAST_TRETRY;
};

void DRV8311Driver::setFastRecoveryRetryTime(DRV8311_FastRecoveryRetryTime time)
{
    DRV8311_FLT_TCTRL fltTCtrl = { .reg = readRegister(DRV8311_FLT_TCTRL_OFFSET) };
...
{
    return (DRV8311_SlowRecoveryRetryTime)((DRV8311_FLT_TCTRL)readRegister(DRV8311_FLT_TCTRL_OFFSET)).SLOW_TRETRY;
};
...
{
    DRV8311_FLT_CLR fltClr = { .FLT_CLR = 0x01 };
...
{
    return (DRV8311_SPISyncClockCycles)((DRV8311_PWMG_CTRL)readRegister(DRV8311_PWMG_CTRL_OFFSET)).SPISYNC_ACRCY;
};

void DRV8311Driver::setSPISyncClockCycles(DRV8311_SPISyncClockCycles cycles)
{
    DRV8311_PWMG_CTRL pwmCtrl = { .reg = readRegister(DRV8311_PWMG_CTRL_OFFSET) };
...
{
    return (DRV8311_SPISyncFrequency)((DRV8311_PWMG_CTRL)readRegister(DRV8311_PWMG_CTRL_OFFSET)).SPICLK_FREQ_SYNC;
};
...
{
    return (DRV8311_OscillatorSyncControl)((DRV8311_PWMG_CTRL)readRegister(DRV8311_PWMG_CTRL_OFFSET)).PWM_OSC_SYNC;
};
...
{
    return (DRV8311_PWMGenCounterMode)((DRV8311_PWMG_CTRL)readRegister(DRV8311_PWMG_CTRL_OFFSET)).PWMCNTR_MODE;
};
...
{
    return (DRV8311_PWM_GEN_ENABLE)((DRV8311_PWMG_CTRL)readRegister(DRV8311_PWMG_CTRL_OFFSET)).PWM_EN;
};
...
{
    return (DRV8311_PWMMode)((PWM_CTRL1_Register)readRegister(DRV8311_PWM_CTRL1_OFFSET)).PWM_MODE;
};

void DRV8311Driver::setPWMMode(DRV8311_PWMMode mode)
{
    PWM_CTRL1_Register pwmCtrl1 = { .reg = readRegister(DRV8311_PWM_CTRL1_OFFSET) };
...
{
    return (DRV8311_SpreadSpectrumModulation)((PWM_CTRL1_Register)readRegister(DRV8311_PWM_CTRL1_OFFSET)).SSC_DIS;
};
...
{
    return (DRV8311_SlewRate)((DRV_CTRL_Register)readRegister(DRV8311_DRV_CTRL_OFFSET)).SLEW_RATE;
};

void DRV8311Driver::setSlewRate(DRV8311_SlewRate rate)
{
    DRV_CTRL_Register drvCtrl = { .reg = readRegister(DRV8311_DRV_CTRL_OFFSET) };
...
{
    return (DRV8311_DeadtimeInsertion)((DRV_CTRL_Register)readRegister(DRV8311_DRV_CTRL_OFFSET)).TDEAD_CTRL;
};
...
{
    return (DRV8311_DriverDelayCompensation)((DRV_CTRL_Register)readRegister(DRV8311_DRV_CTRL_OFFSET)).DLYCMP_EN;
};
...
{
    return (DRV8311_CurrentSenseAmplifierGain)((CSA_CTRL_Register)readRegister(DRV8311_CSA_CTRL_OFFSET)).CSA_GAIN;
};

void DRV8311Driver::setCSAGain(DRV8311_CurrentSenseAmplifierGain gain)
{
    CSA_CTRL_Register csaCtrl = { .reg = readRegister(DRV8311_CSA_CTRL_OFFSET) };
...
{
    return (DRV8311_CurrentSenseAmplifierState)((CSA_CTRL_Register)readRegister(DRV8311_CSA_CTRL_OFFSET)).CSA_EN;
};
...
{
    return (DRV8311_ParityEnable)((SYS_CTRL_Register)readRegister(DRV8311_SYS_CTRL_OFFSET)).SPI_PEN;
}; 

DRV8311_RegisterLock DRV8311Driver::getRegisterLock()
{
    return (DRV8311_RegisterLock)((SYS_CTRL_Register)readRegister(DRV8311_SYS_CTRL_OFFSET)).REG_LOCK;
};

void DRV8311Driver::setRegisterLock(DRV8311_RegisterLock lock)
{
    SYS_CTRL_Register sysCtrl = { .reg = readRegister(DRV8311_SYS_CTRL_OFFSET) };
